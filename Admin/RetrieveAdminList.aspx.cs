...
public partial class Admin_RetrieveAdminList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (data.IsAdminUser(this.progCode, uInfo.UserID) == false)
            {
    ...
    protected void listRepeater_ItemCommand(object source, System.Web.UI.WebControls.RepeaterCommandEventArgs e)
    {
        NoteData data = new NoteData();
    ...
    {
        NoteData data = new NoteData();
        data.RegisterAdminBadUserInfo(this.progCode, this.userID.Text, this.usrType.SelectedValue);
